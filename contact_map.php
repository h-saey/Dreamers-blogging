...
<body>
  ...
  <section class="cont_outer">
    <div class="cont_inn1 d-none d-md-block d-lg-block"></div>
    <div
      class="cont_inn2 align-items-start text-center"
      style="
          padding: 20px;
          display: flex;
      ...
      <div class="contact-info">
        <h2 style="font-weight: 600">
          Get in <span class="italic">touch</span> with us
        </h2>

        <!-- Map -->
        <div class="d-flex h-100 flex-column flex-md-row flex-lg-row" style="margin-top: 30px">
            ...
            <div class="mapouter w-100">
              <div class="gmap_canvas">
                <iframe
                  ...
                  marginheight="0"
                  marginwidth="0"
                  src="https://maps.google.com/maps?width=350&amp;height=350&amp;hl=en&amp;q=punjab university&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed">
                </iframe>
              </div>
            </div>
          </div>
          ...
          <style>
            ...
            .gmap_iframe {
              width: 100%;
              height: 350px;
              /* Fixed height for better display */
              border-radius: 10px;
            }
          ...
          <!-- Contact Details -->
          <div class="contact-details w-100 text-left ml-lg-5 ml-md-5 d-flex flex-row flex-md-column flex-lg-column">
            <div class="m-2">
            ...
            <div class="m-2">
              ...
              <span>SOCIAL:</span>
              <div class="social-icons mt-2 mt-md-4 mt-lg-4">
                <a href="#"><i
                    class="fab fa-facebook-f responsive-icon"
                    style="color: white; margin: 2px"></i></a>
                <a href="#"><i
                    class="fab fa-instagram responsive-icon"
                    style="color: white; margin: 2px"></i></a>
                <a href="#"><i
                    class="fab fa-twitter responsive-icon"
                    style="color: white; margin: 2px"></i></a>
              </div>
            </div>
          </div>
        ...
        <!-- Registration Notice -->
        <p class="register-notice mt-4">
          YOU NEED TO BE
          <span class="bold"><a
              href="log_in.php"
              style="color: rgb(245, 182, 179); font-weight: 500px">REGISTERED</a></span>
